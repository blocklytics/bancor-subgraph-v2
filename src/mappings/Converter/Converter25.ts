...
} from '../../../generated/templates/Converter25/Converter25'
import {
    ERC20Token
} from '../../../generated/templates/Converter25/ERC20Token'
import { 
...
function _updateReserveBalancesAndWeights(converterAddress: Address): void {
    ...
    let converterContract = Converter25.bind(converterAddress);
