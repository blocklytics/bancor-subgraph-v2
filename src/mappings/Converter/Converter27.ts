...
} from '../../../generated/templates/Converter27/Converter27'
import {
    ERC20Token
} from '../../../generated/templates/Converter27/ERC20Token'
import { 
...
function _updateReserveBalancesAndWeights(converterAddress: Address): void {
    ...
    let converterContract = Converter27.bind(converterAddress);
