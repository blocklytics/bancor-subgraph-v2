...
export class Converter25__connectorsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: boolean;
...
export class Converter25__getReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter25__getSaleReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter25__getCrossConnectorReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter25__getPurchaseReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter25__getCrossReserveReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter25__reservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: boolean;
...
export class Converter25 extends ethereum.SmartContract {
  static bind(address: Address): Converter25 {
    return new Converter25("Converter25", address);
  }

  connectors(_address: Address): Converter25__connectorsResult {
    ...
    return new Converter25__connectorsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_connectors(
    _address: Address
  ): ethereum.CallResult<Converter25__connectorsResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Converter25__connectorsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean(),
        value[3].toBoolean(),
  ...
  getReturn(
    ...
    return new Converter25__getReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getReturn(
    ...
    _toToken: Address,
    _amount: BigInt
  ): ethereum.CallResult<Converter25__getReturnResult> {
    let result = super.tryCall(
      "getReturn",
      "getReturn(address,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter25__getReturnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getSaleReturn(
    ...
    _sellAmount: BigInt
  ): Converter25__getSaleReturnResult {
    let result = super.call(
      "getSaleReturn",
    ...
    return new Converter25__getSaleReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getSaleReturn(
    _reserveToken: Address,
    _sellAmount: BigInt
  ): ethereum.CallResult<Converter25__getSaleReturnResult> {
    let result = super.tryCall(
      "getSaleReturn",
      "getSaleReturn(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter25__getSaleReturnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getCrossConnectorReturn(
    ...
    _amount: BigInt
  ): Converter25__getCrossConnectorReturnResult {
    let result = super.call(
      "getCrossConnectorReturn",
    ...
    return new Converter25__getCrossConnectorReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getCrossConnectorReturn(
    ...
    _toConnectorToken: Address,
    _amount: BigInt
  ): ethereum.CallResult<Converter25__getCrossConnectorReturnResult> {
    let result = super.tryCall(
      "getCrossConnectorReturn",
      "getCrossConnectorReturn(address,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter25__getCrossConnectorReturnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getPurchaseReturn(
  ...
  ): Converter25__getPurchaseReturnResult {
    let result = super.call(
      "getPurchaseReturn",
    ...
    return new Converter25__getPurchaseReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPurchaseReturn(
    _reserveToken: Address,
    _depositAmount: BigInt
  ): ethereum.CallResult<Converter25__getPurchaseReturnResult> {
    let result = super.tryCall(
      "getPurchaseReturn",
      "getPurchaseReturn(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter25__getPurchaseReturnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getCrossReserveReturn(
    ...
    _amount: BigInt
  ): Converter25__getCrossReserveReturnResult {
    let result = super.call(
      "getCrossReserveReturn",
    ...
    return new Converter25__getCrossReserveReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getCrossReserveReturn(
    ...
    _toReserveToken: Address,
    _amount: BigInt
  ): ethereum.CallResult<Converter25__getCrossReserveReturnResult> {
    let result = super.tryCall(
      "getCrossReserveReturn",
      "getCrossReserveReturn(address,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter25__getCrossReserveReturnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  reserves(param0: Address): Converter25__reservesResult {
    let result = super.call(
      "reserves",
    ...
    return new Converter25__reservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_reserves(
    param0: Address
  ): ethereum.CallResult<Converter25__reservesResult> {
    let result = super.tryCall(
      "reserves",
      "reserves(address):(uint256,uint32,bool,bool,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter25__reservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean(),
        value[3].toBoolean(),
