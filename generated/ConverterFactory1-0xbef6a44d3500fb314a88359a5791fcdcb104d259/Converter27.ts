...
export class Converter27__connectorsResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: boolean;
...
export class Converter27__getReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter27__getSaleReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter27__getCrossConnectorReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter27__getPurchaseReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter27__getCrossReserveReturnResult {
  value0: BigInt;
  value1: BigInt;
...
export class Converter27__reservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: boolean;
  value3: boolean;
...
export class Converter27 extends ethereum.SmartContract {
  static bind(address: Address): Converter27 {
    return new Converter27("Converter27", address);
  }

  connectors(_address: Address): Converter27__connectorsResult {
    ...
    return new Converter27__connectorsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_connectors(
    _address: Address
  ): ethereum.CallResult<Converter27__connectorsResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Converter27__connectorsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean(),
        value[3].toBoolean(),
  ...
  getReturn(
    ...
    return new Converter27__getReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getReturn(
    ...
    _toToken: Address,
    _amount: BigInt
  ): ethereum.CallResult<Converter27__getReturnResult> {
    let result = super.tryCall(
      "getReturn",
      "getReturn(address,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter27__getReturnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  completeXConversion(
    ...
    let result = super.call(
      ...
      [
        ...
        ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param4)),
        ethereum.Value.fromFixedBytes(param5),
        ethereum.Value.fromFixedBytes(param6)
      ]
    );
  ...
  try_totalReserveRatio(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalReserveRatio",
      "totalReserveRatio():(uint32)",
      []
  ...
  getSaleReturn(
    ...
    _sellAmount: BigInt
  ): Converter27__getSaleReturnResult {
    let result = super.call(
      "getSaleReturn",
    ...
    return new Converter27__getSaleReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getSaleReturn(
    _reserveToken: Address,
    _sellAmount: BigInt
  ): ethereum.CallResult<Converter27__getSaleReturnResult> {
    let result = super.tryCall(
      "getSaleReturn",
      "getSaleReturn(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter27__getSaleReturnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getCrossConnectorReturn(
    ...
    _amount: BigInt
  ): Converter27__getCrossConnectorReturnResult {
    let result = super.call(
      "getCrossConnectorReturn",
    ...
    return new Converter27__getCrossConnectorReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getCrossConnectorReturn(
    ...
    _toConnectorToken: Address,
    _amount: BigInt
  ): ethereum.CallResult<Converter27__getCrossConnectorReturnResult> {
    let result = super.tryCall(
      "getCrossConnectorReturn",
      "getCrossConnectorReturn(address,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter27__getCrossConnectorReturnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getPurchaseReturn(
  ...
  ): Converter27__getPurchaseReturnResult {
    let result = super.call(
      "getPurchaseReturn",
    ...
    return new Converter27__getPurchaseReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPurchaseReturn(
    _reserveToken: Address,
    _depositAmount: BigInt
  ): ethereum.CallResult<Converter27__getPurchaseReturnResult> {
    let result = super.tryCall(
      "getPurchaseReturn",
      "getPurchaseReturn(address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter27__getPurchaseReturnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getCrossReserveReturn(
    ...
    _amount: BigInt
  ): Converter27__getCrossReserveReturnResult {
    let result = super.call(
      "getCrossReserveReturn",
    ...
    return new Converter27__getCrossReserveReturnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getCrossReserveReturn(
    ...
    _toReserveToken: Address,
    _amount: BigInt
  ): ethereum.CallResult<Converter27__getCrossReserveReturnResult> {
    let result = super.tryCall(
      "getCrossReserveReturn",
      "getCrossReserveReturn(address,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter27__getCrossReserveReturnResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  reserves(param0: Address): Converter27__reservesResult {
    let result = super.call(
      "reserves",
    ...
    return new Converter27__reservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBoolean(),
  ...
  try_reserves(
    param0: Address
  ): ethereum.CallResult<Converter27__reservesResult> {
    let result = super.tryCall(
      "reserves",
      "reserves(address):(uint256,uint32,bool,bool,bool)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Converter27__reservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBoolean(),
        value[3].toBoolean(),
  ...
  completeXConversion2(
    ...
    let result = super.call(
      "completeXConversion2",
      "completeXConversion2(address[],uint256,uint256):(uint256)",
      [
        ethereum.Value.fromAddressArray(_path),
        ethereum.Value.fromUnsignedBigInt(_minReturn),
        ethereum.Value.fromUnsignedBigInt(_conversionId)
